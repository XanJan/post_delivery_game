...
namespace PrabdeepDhaliwal.OnScreenKeyboard
{
    public class Key : MonoBehaviour
    {
        ...
        [SerializeField]
        private Color primaryTextColor = Color.white;        // Text color for the primary key text
        public string secondaryValue;          // Secondary character value (e.g., 'A', '!', etc.)
        [SerializeField]
        private Color secondaryTextColor = Color.white;      // Text color for the secondary key text
